...
date = pl.convert_date(const.TABLE_NAME_PLOT27, const.TABLE_NAME_NAMES_PLOT27, const.LANG_LABELS_PLOT_27,
                                  const.DATA_TABLE_COLUMNS_PLOT27,
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot27(lang=lang, start_date=start_date, end_date=end_date)
