...
date = pl.convert_date(const.TABLE_NAME_PLOT31, const.TABLE_NAME_NAMES_PLOT31, const.LANG_LABELS_PLOT_31,
                                  const.DATA_TABLE_COLUMNS_PLOT31,
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot31(lang=lang, start_date=start_date, end_date=end_date)
