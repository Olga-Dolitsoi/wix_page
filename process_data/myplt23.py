...
date = pl.convert_date(const.TABLE_NAME_PLOT28, const.TABLE_NAME_NAMES_PLOT28, const.LANG_LABELS_PLOT_28,
                                  const.DATA_TABLE_COLUMNS_PLOT28,
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot28(lang=lang, start_date=start_date, end_date=end_date)
