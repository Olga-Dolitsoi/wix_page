...
date = pl.prepare_date_year_select_one_str(const.TABLE_NAME_PLOT50, const.TABLE_NAME_NAMES_PLOT50, const.LANG_LABELS_PLOT_50,
                                       const.DATA_TABLE_COLUMNS_PLOT50,
    ...
    if url_search:
        ...
        for param, value in params:
            if param == 'language-dropdown':
                lang = value
    fig, name, source = pl.build_plot50(lang=lang, min_year=start_date, max_year=end_date)
