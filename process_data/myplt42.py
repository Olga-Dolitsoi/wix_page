...
date = pl.prepare_date_month_year_nan(const.TABLE_NAME_PLOT51, const.TABLE_NAME_NAMES_PLOT51, const.LANG_LABELS_PLOT_51)
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot51(lang=lang, start_date=start_date, end_date=end_date)
