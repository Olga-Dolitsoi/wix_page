...
date = pl.prepare_date_month_year(const.TABLE_NAME_PLOT60, const.TABLE_NAME_NAMES_PLOT60, const.LANG_LABELS_PLOT_60)
...
def update_chart(start_date, end_date, lang, url_search):
    ...
    fig, name, source = pl.build_plot60(lang=lang, start_date=start_date, end_date=end_date)
