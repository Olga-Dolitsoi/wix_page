...
date = pl.convert_date(const.TABLE_NAME_PLOT25, const.TABLE_NAME_NAMES_PLOT25, const.LANG_LABELS_PLOT_25,
                                  const.DATA_TABLE_COLUMNS_PLOT25,
...
def update_chart(start_date, end_date, lang):
    fig, name, source = pl.build_plot25(lang=lang, start_date=start_date, end_date=end_date)
