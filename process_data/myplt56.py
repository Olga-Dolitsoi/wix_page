...
date = pl.prepare_date_month_year(const.TABLE_NAME_PLOT63, const.TABLE_NAME_NAMES_PLOT63, const.LANG_LABELS_PLOT_63)
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot63(lang=lang, start_date=start_date, end_date=end_date)
