...
date = pl.convert_date(const.TABLE_NAME_PLOT67, const.TABLE_NAME_NAMES_PLOT67, const.LANG_LABELS_PLOT_67,
                       const.DATA_TABLE_COLUMNS_PLOT67, const.NAMES_TABLE_COLUMNS_PLOT67)
...
def update_chart(start_date, end_date, lang, url_search):
    ...
    fig, name, source = pl.build_plot67(lang=lang, start_date=start_date, end_date=end_date)
