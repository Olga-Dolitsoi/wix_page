...
date = pl.prepare_date_month_year(const.TABLE_NAME_PLOT76, const.TABLE_NAME_NAMES_PLOT76, const.LANG_LABELS_PLOT_76)
...
def update_chart(start_date, end_date, lang, url_search):
    ...
    fig, name, source = pl.build_plot76(lang=lang, start_date=start_date, end_date=end_date)
