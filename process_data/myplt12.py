...
date = pl.prepare_date_year_select_one(const.TABLE_NAME_PLOT17, const.TABLE_NAME_NAMES_PLOT17, const.LANG_LABELS_PLOT_17)
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot17(lang=lang, min_year=start_date, max_year=end_date)
