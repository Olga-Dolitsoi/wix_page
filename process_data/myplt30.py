...
date = pl.convert_date(const.TABLE_NAME_PLOT37, const.TABLE_NAME_NAMES_PLOT37, const.LANG_LABELS_PLOT_37)
date_start = date.min()
date_end = date.max()
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot37(lang=lang, start_date=start_date, end_date=end_date)
