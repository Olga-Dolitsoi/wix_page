...
date = pl.prepare_date_month_year(const.TABLE_NAME_PLOT73, const.TABLE_NAME_NAMES_PLOT73, const.LANG_LABELS_PLOT_73,
                                  const.DATA_TABLE_COLUMNS_PLOT73, const.NAMES_TABLE_COLUMNS_PLOT73)
...
def update_chart(start_date, end_date, lang):
    fig, name, source = pl.build_plot73(lang=lang, start_date=start_date, end_date=end_date)
