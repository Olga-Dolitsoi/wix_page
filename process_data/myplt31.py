...
date = pl.convert_date(const.TABLE_NAME_PLOT38, const.TABLE_NAME_NAMES_PLOT38, const.LANG_LABELS_PLOT_38,
                                  const.DATA_TABLE_COLUMNS_PLOT38,
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot38(lang=lang, start_date=start_date, end_date=end_date)
