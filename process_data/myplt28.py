...
date = pl.convert_date(const.TABLE_NAME_PLOT33, const.TABLE_NAME_NAMES_PLOT33, const.LANG_LABELS_PLOT_33,
                                  const.DATA_TABLE_COLUMNS_PLOT33,
...
def update_chart(start_date, end_date, lang, url_search):
    ...
    fig, name, source = pl.build_plot33(lang=lang, start_date=start_date, end_date=end_date)
