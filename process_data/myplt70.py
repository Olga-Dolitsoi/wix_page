...
date = pl.prepare_date_month_year(const.TABLE_NAME_PLOT77, const.TABLE_NAME_NAMES_PLOT77, const.LANG_LABELS_PLOT_77,
                                  const.DATA_TABLE_COLUMNS_PLOT77, const.NAMES_TABLE_COLUMNS_PLOT77)
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot77(lang=lang, start_date=start_date, end_date=end_date)
