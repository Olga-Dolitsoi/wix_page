...
date = pl.convert_date(const.TABLE_NAME_PLOT32, const.TABLE_NAME_NAMES_PLOT32, const.LANG_LABELS_PLOT_32,
                                  const.DATA_TABLE_COLUMNS_PLOT32,
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot32(lang=lang, start_date=start_date, end_date=end_date)
