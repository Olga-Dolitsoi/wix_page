...
date = pl.prepare_date_year_select_one(const.TABLE_NAME_PLOT7, const.TABLE_NAME_NAMES_PLOT7, const.LANG_LABELS_PLOT_7)
...
def update_chart(start_date, end_date, url_search):
    ...
    fig, name, source = pl.build_plot7(lang=lang, start_date=start_date, end_date=end_date)
