...
date = pl.convert_date(const.TABLE_NAME_PLOT29, const.TABLE_NAME_NAMES_PLOT29, const.LANG_LABELS_PLOT_29,
                                  const.DATA_TABLE_COLUMNS_PLOT29,
...
def update_chart(start_date, end_date, lang, url_search):
    ...
    fig, name, source = pl.build_plot29(lang=lang, start_date=start_date, end_date=end_date)
