...
date = pl.prepare_date_year_select_one(const.TABLE_NAME_PLOT6, const.TABLE_NAME_NAMES_PLOT6, const.LANG_LABELS_PLOT_6)
...
def update_chart(year, url_search):
    ...
    fig, name, source = pl.build_plot6(lang=lang, year=year)
